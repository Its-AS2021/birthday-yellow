...
function getDefaultNote(name) {
  return `Dearest ${name},\n\nHappy Birthday my yellow one 💛✨. I'm really sorry for our argument and for not talking these past days. I miss you a lot. You are very special to me and I never wanted to hurt you.\n\nHope your day is as beautiful as you. I hope you can understand me. I value our friendship a lot. Hope we talk soon and fix everything ok!!🕊️✨.\n\nWith all my love,`;
}
...
const giftMessages = [
  ...
  "You are my yellow forever💛, the warmth my heart never wants to lose. 🕯️",
];
